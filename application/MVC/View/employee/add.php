                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="post" name="addemployee" action="<?php echo ADMIN_TAX_EMPLOYEE_INSERT_LINK; ?>">                                                                                                                                          
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" <?php if(isset($_SESSION['data'])){ echo 'value="'.$_SESSION['data']['tax_employee_password'].'"';} ?> name="tax_employee_password"  placeholder="Enter password" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
