                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="post" name="addtaxcommodity" action="<?php echo ADMIN_TAX_COMMODITY_INSERT_LINK; ?>">                                                                                                                                          
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" <?php if(isset($_SESSION['data'])){ echo 'value="'.$_SESSION['data']['tax_commodity_subhead'].'"';} ?> name="tax_commodity_subhead"  placeholder="Enter sub head" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
