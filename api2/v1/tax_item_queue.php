...
//             promocode();                        
            ...
            verifyRequiredParams(array('item_queue_id','queue_session','type_name','commodity_name','vehicle_number','item_quantity','item_quantity_units','item_tax_amount','item_status','commodity_id','type_id','created_by','modified_by', 'token', 'device'));
...
$APP->post('get-challan-data', false, function() use($APP) {
            ...
            if ($result) {
				...
				//$result[0]["challan_code"] = $this->home_m->getTaxDetailsComodityHead($_SESSION['unregistered']);
